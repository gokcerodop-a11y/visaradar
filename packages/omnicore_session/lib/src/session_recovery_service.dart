...
class SessionRecoveryService {
  ...
  Future<void> save(SessionSnapshot snap, KeyValueStorage storage) async {
  ...
  Future<void> consume(KeyValueStorage storage) async {
    _pending = null;
    await _clear(storage);
  }
  ...
  Future<void> clearOnCleanExit(KeyValueStorage storage) async {
    _pending = null;
    await _clear(storage);
  }

  Future<void> _clear(KeyValueStorage storage) async {
